export const dailyRoutine = `Perfect for if you're looking for soft, nourished skin, our
...
export const endpoint = 'https://jeval.com.au/collections/hair-care/products.json?page=1'